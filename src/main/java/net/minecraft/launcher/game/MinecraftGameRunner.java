...
import com.mojang.launcher.game.process.direct.*;
...
import com.mojang.launcher.updater.download.assets.*;
...
public class MinecraftGameRunner extends AbstractGameRunner implements GameProcessRunnable
{
    ...
    private void migrateOldAssets() {
        ...
        for (final File file : new TreeSet<>(FileUtils.listFiles(sourceDir, TrueFileFilter.TRUE, migratableFilter))) {
