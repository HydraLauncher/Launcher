...
public abstract class BaseUserAuthentication implements UserAuthentication
{
    ...
    public void loadFromStorage(final Map<String, Object> credentials) {
        ...
        if (credentials.containsKey("userProperties")) {
            try {
                final List<Map<String, Object>> list = (List<Map<String, Object>>) credentials.get("userProperties");
                for (final Map<String, Object> propertyMap : list) {
                    final String name = (String) propertyMap.get("name");
                    final String value = (String) propertyMap.get("value");
                    final String signature = (String) propertyMap.get("signature");
                    if (signature == null) {
        ...
        if (credentials.containsKey("displayName") && credentials.containsKey("uuid")) {
            ...
            if (credentials.containsKey("profileProperties")) {
                try {
                    final List<Map<String, Object>> list2 = (List<Map<String, Object>>) credentials.get("profileProperties");
                    for (final Map<String, Object> propertyMap2 : list2) {
                        final String name2 = (String) propertyMap2.get("name");
                        final String value2 = (String) propertyMap2.get("value");
                        final String signature2 = (String) propertyMap2.get("signature");
                        if (signature2 == null) {
