...
public class YggdrasilUserAuthentication extends HttpUserAuthentication
{
    ...
    private static final String BASE_URL = "https://authserver.gethydra.org/"; //TODO: moderator_man (modified for hydra)
    ...
    static {
        ...
        ROUTE_AUTHENTICATE = HttpAuthenticationService.constantURL("https://authserver.gethydra.org/authenticate"); //TODO: moderator_man (modified for hydra)
        ROUTE_REFRESH = HttpAuthenticationService.constantURL("https://authserver.gethydra.org/refresh"); //TODO: moderator_man (modified for hydra)
        ROUTE_VALIDATE = HttpAuthenticationService.constantURL("https://authserver.gethydra.org/validate"); //TODO: moderator_man (modified for hydra)
        ROUTE_INVALIDATE = HttpAuthenticationService.constantURL("https://authserver.gethydra.org/invalidate"); //TODO: moderator_man (modified for hydra)
        ROUTE_SIGNOUT = HttpAuthenticationService.constantURL("https://authserver.gethydra.org/signout"); //TODO: moderator_man (modified for hydra)
    }
}
